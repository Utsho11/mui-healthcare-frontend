...
import { useGetAllSpecialityQuery } from "@/redux/api/specialitiesApi";
...
const ProfileUpdateModal = ({ open, setOpen, id }: TProps) => {
  ...
  const { data: allSpecialties } = useGetAllSpecialityQuery(undefined);
  ...
  return (
    <MUIFullScreenModal open={open} setOpen={setOpen} title="Update Profile">
      <MUIForm
      ...
      >
        <Grid container spacing={2} sx={{ my: 5 }}>
          ...
          >
            <MUIInput name="name" label="Name" sx={{ mb: 2 }} fullWidth />
          </Grid>
          <Grid
            size={{
              xs: 12,
          ...
          >
            <MUIInput name="address" label="Address" sx={{ mb: 2 }} fullWidth />
          </Grid>
          <Grid
            size={{
              xs: 12,
